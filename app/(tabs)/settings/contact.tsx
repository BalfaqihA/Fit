...
export default function ContactSupport() {
  ...
  useEffect(() => {
    ...
    const unsub = subscribeSupportMessages(
      ...
      (list) => {
        setMessages(list);
        setLoading(false);
        markSupportThreadRead(user.uid, 'user').catch(() => {});
      },
      () => setLoading(false)
    );
    return unsub;
  ...
  const onSend = async () => {
    ...
    try {
      ...
      // error is captured upstream; keep the text so the user can retry
    } finally {
      setSending(false);
    }
  };
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                ...
                <Text style={styles.emptySub}>
                  Send us a message and our team will reply right here. You’ll
                  see responses in this chat.
                </Text>
              </View>
            }
            renderItem={({ item }) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {!mine && <Text style={styles.bubbleAuthor}>Support</Text>}
                    <Text
                      style={[
                        styles.bubbleText,
                        mine && { color: '#FFFFFF' },
